 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(I,L){var B=I.length;I.push(L);e:for(;0<B;){var V=B-1>>>1,Q=I[V];if(0<i(Q,L))I[V]=L,I[B]=Q,B=V;else break e}}function n(I){return I.length===0?null:I[0]}function r(I){if(I.length===0)return null;var L=I[0],B=I.pop();if(B!==L){I[0]=B;e:for(var V=0,Q=I.length,Re=Q>>>1;V<Re;){var te=2*(V+1)-1,Kt=I[te],Ke=te+1,Rt=I[Ke];if(0>i(Kt,B))Ke<Q&&0>i(Rt,Kt)?(I[V]=Rt,I[Ke]=B,V=Ke):(I[V]=Kt,I[te]=B,V=te);else if(Ke<Q&&0>i(Rt,B))I[V]=Rt,I[Ke]=B,V=Ke;else break e}}return L}function i(I,L){var B=I.sortIndex-L.sortIndex;return B!==0?B:I.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var a=Date,s=a.now();e.unstable_now=function(){return a.now()-s}}var l=[],d=[],g=1,y=null,p=3,w=!1,m=!1,E=!1,k=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function u(I){for(var L=n(d);L!==null;){if(L.callback===null)r(d);else if(L.startTime<=I)r(d),L.sortIndex=L.expirationTime,t(l,L);else break;L=n(d)}}function c(I){if(E=!1,u(I),!m)if(n(l)!==null)m=!0,z(v);else{var L=n(d);L!==null&&U(c,L.startTime-I)}}function v(I,L){m=!1,E&&(E=!1,h(T),T=-1),w=!0;var B=p;try{for(u(L),y=n(l);y!==null&&(!(y.expirationTime>L)||I&&!O());){var V=y.callback;if(typeof V=="function"){y.callback=null,p=y.priorityLevel;var Q=V(y.expirationTime<=L);L=e.unstable_now(),typeof Q=="function"?y.callback=Q:y===n(l)&&r(l),u(L)}else r(l);y=n(l)}if(y!==null)var Re=!0;else{var te=n(d);te!==null&&U(c,te.startTime-L),Re=!1}return Re}finally{y=null,p=B,w=!1}}var S=!1,_=null,T=-1,b=5,$=-1;function O(){return!(e.unstable_now()-$<b)}function x(){if(_!==null){var I=e.unstable_now();$=I;var L=!0;try{L=_(!0,I)}finally{L?D():(S=!1,_=null)}}else S=!1}var D;if(typeof f=="function")D=function(){f(x)};else if(typeof MessageChannel<"u"){var j=new MessageChannel,R=j.port2;j.port1.onmessage=x,D=function(){R.postMessage(null)}}else D=function(){k(x,0)};function z(I){_=I,S||(S=!0,D())}function U(I,L){T=k(function(){I(e.unstable_now())},L)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(I){I.callback=null},e.unstable_continueExecution=function(){m||w||(m=!0,z(v))},e.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):b=0<I?Math.floor(1e3/I):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return n(l)},e.unstable_next=function(I){switch(p){case 1:case 2:case 3:var L=3;break;default:L=p}var B=p;p=L;try{return I()}finally{p=B}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(I,L){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var B=p;p=I;try{return L()}finally{p=B}},e.unstable_scheduleCallback=function(I,L,B){var V=e.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?V+B:V):B=V,I){case 1:var Q=-1;break;case 2:Q=250;break;case 5:Q=1073741823;break;case 4:Q=1e4;break;default:Q=5e3}return Q=B+Q,I={id:g++,callback:L,priorityLevel:I,startTime:B,expirationTime:Q,sortIndex:-1},B>V?(I.sortIndex=B,t(d,I),n(l)===null&&I===n(d)&&(E?(h(T),T=-1):E=!0,U(c,B-V))):(I.sortIndex=Q,t(l,I),m||w||(m=!0,z(v))),I},e.unstable_shouldYield=O,e.unstable_wrapCallback=function(I){var L=p;return function(){var B=p;p=L;try{return I.apply(this,arguments)}finally{p=B}}}})(Np);jp.exports=Np;var Qg=jp.exports;/**
 * @license React
...
`,G_={GoTopBtn:Y_},K_=()=>{const[e,t]=F.useState(!1);return F.useEffect(()=>{window.addEventListener("scroll",()=>{window.scrollY>200?t(!0):t(!1)})},[]),P.jsx(P.Fragment,{children:e&&P.jsx(G_.GoTopBtn,{onClick:()=>A0.scrollToTop({duration:0}),children:"↑"})})},q_="/ragnarok-landing/assets/bg-b59dc2c9.webp",Z_="/ragnarok-landing/assets/bg-2x-3ad4c3e7.webp",J_="/ragnarok-landing/assets/snow-5e353014.webp",eE=C.section`
    padding-top: 23rem;
    min-height: 77rem;
    position: relative;
...
`,iE=C.p`
    ...
    font-size: 1.8rem;
    color: ${({theme:e})=>e.colors.sea};
`,Yr={Main:eE,MainContainer:tE,MainWrapper:nE,MainTitle:rE,MainDescription:iE},oE=({onClickBuyNow:e})=>P.jsx(Yr.Main,{children:P.jsx(Yr.MainContainer,{children:P.jsxs(Yr.MainWrapper,{children:[P.jsx(Yr.MainTitle,{children:"God of War Ragnarök"}),P.jsx(Yr.MainDescription,{children:"Taking place three years following the events of the previous game, Fimbulwinter, a great winter that spans three summers, is drawing to a close which will begin the prophesied Ragnarök."}),P.jsx(Mr,{title:"buy now",callback:()=>e("standard edition",19.99)})]})})});function aE(e){if(e.sheet)return e.sheet;for(var t=0;t<document.styleSheets.length;t++)if(document.styleSheets[t].ownerNode===e)return document.styleSheets[t]}function sE(e){var t=document.createElement("style");return t.setAttribute("data-emotion",e.key),e.nonce!==void 0&&t.setAttribute("nonce",e.nonce),t.appendChild(document.createTextNode("")),t.setAttribute("data-s",""),t}var lE=function(){function e(n){var r=this;this._insertTag=function(i){var o;r.tags.length===0?r.insertionPoint?o=r.insertionPoint.nextSibling:r.prepend?o=r.container.firstChild:o=r.before:o=r.tags[r.tags.length-1].nextSibling,r.container.insertBefore(i,o),r.tags.push(i)},this.isSpeedy=n.speedy===void 0?!0:n.speedy,this.tags=[],this.ctr=0,this.nonce=n.nonce,this.key=n.key,this.container=n.container,this.prepend=n.prepend,this.insertionPoint=n.insertionPoint,this.before=null}var t=e.prototype;return t.hydrate=function(r){r.forEach(this._insertTag)},t.insert=function(r){this.ctr%(this.isSpeedy?65e3:1)===0&&this._insertTag(sE(this));var i=this.tags[this.tags.length-1];if(this.isSpeedy){var o=aE(i);try{o.insertRule(r,o.cssRules.length)}catch{}}else i.appendChild(document.createTextNode(r));this.ctr++},t.flush=function(){this.tags.forEach(function(r){return r.parentNode&&r.parentNode.removeChild(r)}),this.tags=[],this.ctr=0},e}(),je="-ms-",ka="-moz-",Y="-webkit-",j0="comm",Hc="rule",Vc="decl",uE="@import",N0="@keyframes",cE="@layer",dE=Math.abs,ns=String.fromCharCode,fE=Object.assign;function pE(e,t){return Oe(e,0)^45?(((t<<2^Oe(e,0))<<2^Oe(e,1))<<2^Oe(e,2))<<2^Oe(e,3):0}function L0(e){return e.trim()}function mE(e,t){return(e=t.exec(e))?e[0]:e}function G(e,t,n){return e.replace(t,n)}function ku(e,t){return e.indexOf(t)}function Oe(e,t){return e.charCodeAt(t)|0}function Di(e,t,n){return e.slice(t,n)}function bt(e){return e.length}function Xc(e){return e.length}function ko(e,t){return t.push(e),e}function hE(e,t){return e.map(t).join("")}var rs=1,Cr=1,R0=0,Ge=0,ye=0,jr="";function is(e,t,n,r,i,o,a){return{value:e,root:t,parent:n,type:r,props:i,children:o,line:rs,column:Cr,length:a,return:""}}function Gr(e,t){return fE(is("",null,null,"",null,null,0),e,{length:-e.length},t)}function gE(){return ye}function vE(){return ye=Ge>0?Oe(jr,--Ge):0,Cr--,ye===10&&(Cr=1,rs--),ye}function tt(){return ye=Ge<R0?Oe(jr,Ge++):0,Cr++,ye===10&&(Cr=1,rs++),ye}function jt(){return Oe(jr,Ge)}function Qo(){return Ge}function Yi(e,t){return Di(jr,e,t)}function $i(e){switch(e){case 0:case 9:case 10:case 13:case 32:return 5;case 33:case 43:case 44:case 47:case 62:case 64:case 126:case 59:case 123:case 125:return 4;case 58:return 3;case 34:case 39:case 40:case 91:return 2;case 41:case 93:return 1}return 0}function z0(e){return rs=Cr=1,R0=bt(jr=e),Ge=0,[]}function F0(e){return jr="",e}function Yo(e){return L0(Yi(Ge-1,Iu(e===91?e+2:e===40?e+1:e)))}function yE(e){for(;(ye=jt())&&ye<33;)tt();return $i(e)>2||$i(ye)>3?"":" "}function SE(e,t){for(;--t&&tt()&&!(ye<48||ye>102||ye>57&&ye<65||ye>70&&ye<97););return Yi(e,Qo()+(t<6&&jt()==32&&tt()==32))}function Iu(e){for(;tt();)switch(ye){case e:return Ge;case 34:case 39:e!==34&&e!==39&&Iu(ye);break;case 40:e===41&&Iu(e);break;case 92:tt();break}return Ge}function wE(e,t){for(;tt()&&e+ye!==47+10;)if(e+ye===42+42&&jt()===47)break;return"/*"+Yi(t,Ge-1)+"*"+ns(e===47?e:tt())}function _E(e){for(;!$i(jt());)tt();return Yi(e,Ge)}function EE(e){return F0(Go("",null,null,null,[""],e=z0(e),0,[0],e))}function Go(e,t,n,r,i,o,a,s,l){for(var d=0,g=0,y=a,p=0,w=0,m=0,E=1,k=1,h=1,f=0,u="",c=i,v=o,S=r,_=u;k;)switch(m=f,f=tt()){case 40:if(m!=108&&Oe(_,y-1)==58){ku(_+=G(Yo(f),"&","&\f"),"&\f")!=-1&&(h=-1);break}case 34:case 39:case 91:_+=Yo(f);break;case 9:case 10:case 13:case 32:_+=yE(m);break;case 92:_+=SE(Qo()-1,7);continue;case 47:switch(jt()){case 42:case 47:ko(PE(wE(tt(),Qo()),t,n),l);break;default:_+="/"}break;case 123*E:s[d++]=bt(_)*h;case 125*E:case 59:case 0:switch(f){case 0:case 125:k=0;case 59+g:h==-1&&(_=G(_,/\f/g,"")),w>0&&bt(_)-y&&ko(w>32?np(_+";",r,n,y-1):np(G(_," ","")+";",r,n,y-2),l);break;case 59:_+=";";default:if(ko(S=tp(_,t,n,d,g,i,s,u,c=[],v=[],y),o),f===123)if(g===0)Go(_,t,S,S,c,o,y,s,v);else switch(p===99&&Oe(_,3)===110?100:p){case 100:case 108:case 109:case 115:Go(e,S,S,r&&ko(tp(e,S,S,0,0,i,s,u,i,c=[],y),v),i,v,y,s,r?c:v);break;default:Go(_,S,S,S,[""],v,0,s,v)}}d=g=w=0,E=h=1,u=_="",y=a;break;case 58:y=1+bt(_),w=m;default:if(E<1){if(f==123)--E;else if(f==125&&E++==0&&vE()==125)continue}switch(_+=ns(f),f*E){case 38:h=g>0?1:(_+="\f",-1);break;case 44:s[d++]=(bt(_)-1)*h,h=1;break;case 64:jt()===45&&(_+=Yo(tt())),p=jt(),g=y=bt(u=_+=_E(Qo())),f++;break;case 45:m===45&&bt(_)==2&&(E=0)}}return o}function tp(e,t,n,r,i,o,a,s,l,d,g){for(var y=i-1,p=i===0?o:[""],w=Xc(p),m=0,E=0,k=0;m<r;++m)for(var h=0,f=Di(e,y+1,y=dE(E=a[m])),u=e;h<w;++h)(u=L0(E>0?p[h]+" "+f:G(f,/&\f/g,p[h])))&&(l[k++]=u);return is(e,t,n,i===0?Hc:s,l,d,g)}function PE(e,t,n){return is(e,t,n,j0,ns(gE()),Di(e,2,-2),0)}function np(e,t,n,r){return is(e,t,n,Vc,Di(e,0,r),Di(e,r+1,-1),r)}function hr(e,t){for(var n="",r=Xc(e),i=0;i<r;i++)n+=t(e[i],i,e,t)||"";return n}function TE(e,t,n,r){switch(e.type){case cE:if(e.children.length)break;case uE:case Vc:return e.return=e.return||e.value;case j0:return"";case N0:return e.return=e.value+"{"+hr(e.children,r)+"}";case Hc:e.value=e.props.join(",")}return bt(n=hr(e.children,r))?e.return=e.value+"{"+n+"}":""}function xE(e){var t=Xc(e);return function(n,r,i,o){for(var a="",s=0;s<t;s++)a+=e[s](n,r,i,o)||"";return a}}function kE(e){return function(t){t.root||(t=t.return)&&e(t)}}var IE=function(t,n,r){for(var i=0,o=0;i=o,o=jt(),i===38&&o===12&&(n[r]=1),!$i(o);)tt();return Yi(t,Ge)},CE=function(t,n){var r=-1,i=44;do switch($i(i)){case 0:i===38&&jt()===12&&(n[r]=1),t[r]+=IE(Ge-1,n,r);break;case 2:t[r]+=Yo(i);break;case 4:if(i===44){t[++r]=jt()===58?"&\f":"",n[r]=t[r].length;break}default:t[r]+=ns(i)}while(i=tt());return t},OE=function(t,n){return F0(CE(z0(t),n))},rp=new WeakMap,bE=function(t){if(!(t.type!=="rule"||!t.parent||t.length<1)){for(var n=t.value,r=t.parent,i=t.column===r.column&&t.line===r.line;r.type!=="rule";)if(r=r.parent,!r)return;if(!(t.props.length===1&&n.charCodeAt(0)!==58&&!rp.get(r))&&!i){rp.set(t,!0);for(var o=[],a=OE(n,o),s=r.props,l=0,d=0;l<a.length;l++)for(var g=0;g<s.length;g++,d++)t.props[d]=o[l]?a[l].replace(/&\f/g,s[g]):s[g]+" "+a[l]}}},AE=function(t){if(t.type==="decl"){var n=t.value;n.charCodeAt(0)===108&&n.charCodeAt(2)===98&&(t.return="",t.value="")}};function B0(e,t){switch(pE(e,t)){case 5103:return Y+"print-"+e+e;case 5737:case 4201:case 3177:case 3433:case 1641:case 4457:case 2921:case 5572:case 6356:case 5844:case 3191:case 6645:case 3005:case 6391:case 5879:case 5623:case 6135:case 4599:case 4855:case 4215:case 6389:case 5109:case 5365:case 5621:case 3829:return Y+e+e;case 5349:case 4246:case 4810:case 6968:case 2756:return Y+e+ka+e+je+e+e;case 6828:case 4268:return Y+e+je+e+e;case 6165:return Y+e+je+"flex-"+e+e;case 5187:return Y+e+G(e,/(\w+).+(:[^]+)/,Y+"box-$1$2"+je+"flex-$1$2")+e;case 5443:return Y+e+je+"flex-item-"+G(e,/flex-|-self/,"")+e;case 4675:return Y+e+je+"flex-line-pack"+G(e,/align-content|flex-|-self/,"")+e;case 5548:return Y+e+je+G(e,"shrink","negative")+e;case 5292:return Y+e+je+G(e,"basis","preferred-size")+e;case 6060:return Y+"box-"+G(e,"-grow","")+Y+e+je+G(e,"grow","positive")+e;case 4554:return Y+G(e,/([^-])(transform)/g,"$1"+Y+"$2")+e;case 6187:return G(G(G(e,/(zoom-|grab)/,Y+"$1"),/(image-set)/,Y+"$1"),e,"")+e;case 5495:case 3959:return G(e,/(image-set\([^]*)/,Y+"$1$`$1");case 4968:return G(G(e,/(.+:)(flex-)?(.*)/,Y+"box-pack:$3"+je+"flex-pack:$3"),/s.+-b[^;]+/,"justify")+Y+e+e;case 4095:case 3583:case 4068:case 2532:return G(e,/(.+)-inline(.+)/,Y+"$1$2")+e;case 8116:case 7059:case 5753:case 5535:case 5445:case 5701:case 4933:case 4677:case 5533:case 5789:case 5021:case 4765:if(bt(e)-1-t>6)switch(Oe(e,t+1)){case 109:if(Oe(e,t+4)!==45)break;case 102:return G(e,/(.+:)(.+)-([^]+)/,"$1"+Y+"$2-$3$1"+ka+(Oe(e,t+3)==108?"$3":"$2-$3"))+e;case 115:return~ku(e,"stretch")?B0(G(e,"stretch","fill-available"),t)+e:e}break;case 4949:if(Oe(e,t+1)!==115)break;case 6444:switch(Oe(e,bt(e)-3-(~ku(e,"!important")&&10))){case 107:return G(e,":",":"+Y)+e;case 101:return G(e,/(.+:)([^;!]+)(;|!.+)?/,"$1"+Y+(Oe(e,14)===45?"inline-":"")+"box$3$1"+Y+"$2$3$1"+je+"$2box$3")+e}break;case 5936:switch(Oe(e,t+11)){case 114:return Y+e+je+G(e,/[svh]\w+-[tblr]{2}/,"tb")+e;case 108:return Y+e+je+G(e,/[svh]\w+-[tblr]{2}/,"tb-rl")+e;case 45:return Y+e+je+G(e,/[svh]\w+-[tblr]{2}/,"lr")+e}return Y+e+je+e+e}return e}var DE=function(t,n,r,i){if(t.length>-1&&!t.return)switch(t.type){case Vc:t.return=B0(t.value,t.length);break;case N0:return hr([Gr(t,{value:G(t.value,"@","@"+Y)})],i);case Hc:if(t.length)return hE(t.props,function(o){switch(mE(o,/(::plac\w+|:read-\w+)/)){case":read-only":case":read-write":return hr([Gr(t,{props:[G(o,/:(read-\w+)/,":"+ka+"$1")]})],i);case"::placeholder":return hr([Gr(t,{props:[G(o,/:(plac\w+)/,":"+Y+"input-$1")]}),Gr(t,{props:[G(o,/:(plac\w+)/,":"+ka+"$1")]}),Gr(t,{props:[G(o,/:(plac\w+)/,je+"input-$1")]})],i)}return""})}},$E=[DE],ME=function(t){var n=t.key;if(n==="css"){var r=document.querySelectorAll("style[data-emotion]:not([data-s])");Array.prototype.forEach.call(r,function(E){var k=E.getAttribute("data-emotion");k.indexOf(" ")!==-1&&(document.head.appendChild(E),E.setAttribute("data-s",""))})}var i=t.stylisPlugins||$E,o={},a,s=[];a=t.container||document.head,Array.prototype.forEach.call(document.querySelectorAll('style[data-emotion^="'+n+' "]'),function(E){for(var k=E.getAttribute("data-emotion").split(" "),h=1;h<k.length;h++)o[k[h]]=!0;s.push(E)});var l,d=[bE,AE];{var g,y=[TE,kE(function(E){g.insert(E)})],p=xE(d.concat(i,y)),w=function(k){return hr(EE(k),p)};l=function(k,h,f,u){g=f,w(k?k+"{"+h.styles+"}":h.styles),u&&(m.inserted[h.name]=!0)}}var m={key:n,sheet:new lE({key:n,container:a,nonce:t.nonce,speedy:t.speedy,prepend:t.prepend,insertionPoint:t.insertionPoint}),nonce:t.nonce,inserted:o,registered:{},insert:l};return m.sheet.hydrate(s),m},U0={exports:{}},Z={};/** @license React v16.13.1
...
`;function k2({duration:e=1e3,delay:t=0,timingFunction:n="ease",keyframes:r=td,iterationCount:i=1}){return J0`
...
`,vt={DualSense:GP,DualSenseHeading:KP,DualSenseWrapper:qP,DualSenseInfo:ZP,DualSenseDescription:JP,GameName:e3,Discount:t3,Price:n3,ImageWrapper:r3,DualSenseImage:i3},o3="/ragnarok-landing/assets/dual-fc7a3f21.webp",a3="/ragnarok-landing/assets/dual-2x-739ef62d.webp",s3=({onClickBuyNow:e})=>P.jsx(vt.DualSense,{id:"controller",children:P.jsxs(Vn,{children:[P.jsx(vt.DualSenseHeading,{children:"DualSense"}),P.jsxs(vt.DualSenseWrapper,{justify:"center",gap:"15rem",children:[P.jsx(nP,{direction:"left",duration:600,triggerOnce:!0,children:P.jsxs(vt.DualSenseInfo,{children:[P.jsxs(vt.DualSenseDescription,{children:["You can also buy an exclusive controller with the"," ",P.jsx(vt.GameName,{children:"God of War Ragnarok"})," theme for PS5"]}),P.jsxs(vt.DualSenseDescription,{children:["If you purchase a controller and a game (any edition), you will receive a ",P.jsx(vt.Discount,{children:"15%"})," discount on two items."]}),P.jsxs(Ee,{align:"center",gap:"3.3rem",children:[P.jsx(vt.Price,{children:"35.99$"}),P.jsx(Mr,{title:"buy dualsense with a game",color:"secondary",size:"big",callback:()=>e("Controller with Digital Deluxe Edition",35.99)})]})]})}),P.jsx(vt.ImageWrapper,{duration:600,triggerOnce:!0,children:P.jsx(vt.DualSenseImage,{src:o3,srcSet:`${a3} 2x`,alt:"dual-sense",width:"340",height:"309"})})]})]})}),l3=C.section`
    padding-top: 6rem;
`,u3=C(Nr)`
...
`,f3=C.video`
    width: 100%;
    height: auto;
`,Yn={About:l3,AboutHeading:u3,VideoWrapper:c3,VideoInfo:lg,VideoTitle:d3,Video:f3},p3="/ragnarok-landing/assets/trailer-9424fb52.mp4",m3="/ragnarok-landing/assets/bg-video-4486cfd0.webp",h3=()=>{const[e,t]=F.useState(!1),n=F.useRef(null),r=()=>{const i=n.current;i&&(e?i.pause():i.play(),t(!e))};return P.jsx(Yn.About,{id:"about",children:P.jsxs(sg,{duration:500,triggerOnce:!0,children:[P.jsx(Yn.AboutHeading,{children:"About Game"}),P.jsxs(Yn.VideoWrapper,{playing:e?e.toString():"",children:[P.jsxs(Yn.VideoInfo,{children:[P.jsx(Yn.VideoTitle,{children:"Watch the Trailer"}),P.jsx(Mr,{onClick:r,title:e?"pause":"play",color:"dark"})]}),P.jsx(Yn.Video,{ref:n,src:p3,poster:m3})]})]})})},g3=C.section`
    padding-top: 8.8rem;
    overflow: hidden;
`,v3=C(Nr)`
    margin-bottom: 3.2rem;
...
`,_T=C.img``,kn={NewsSlide:hT,NewsContent:gT,NewsTitle:vT,GameName:yT,Date:ST,NewsDescription:wT,NewsImage:_T},ET=({item:e})=>P.jsxs(kn.NewsSlide,{children:[P.jsxs(Ee,{justify:"space-between",children:[P.jsx(kn.GameName,{children:"God of War Ragnarok"}),P.jsx(kn.Date,{children:e.date})]}),P.jsx(kn.NewsTitle,{children:e.title}),P.jsxs(kn.NewsContent,{gap:"2.4rem",children:[P.jsx(kn.NewsImage,{src:e.img,srcSet:`${e.img2x} 2x`,alt:e.title,width:"278",height:"249"}),P.jsx(kn.NewsDescription,{children:e.description})]})]}),PT=({data:e})=>{const t=e.map((n,r)=>P.jsx(ET,{item:n,"data-value":r+1},r));return P.jsx(mT,{items:t,autoWidth:!0,autoPlay:!0,autoPlayStrategy:"none",autoPlayInterval:2e3,animationDuration:1500,animationType:"fadeout",mouseTracking:!0,disableDotsControls:!0,infinite:!0,keyboardNavigation:!0})},TT=()=>P.jsxs(pp.News,{id:"news",children:[P.jsx(pp.NewsHeading,{children:"News"}),P.jsx(PT,{data:jP})]}),xT=C.section`
    padding-top: 10rem;
`,kT=C(Nr)`
    margin-bottom: 3.7rem;
`,_p={FAQ:xT,FAQHeading:kT},IT=C.div`
